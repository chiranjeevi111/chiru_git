...
- **Nor**: He doesn’t like tea, **nor** does he like coffee. (Adds negative information)
    Yes, you’re absolutely correct! The sentence "He doesn’t like tea, nor does he like coffee" means:
...
- **Whether...or**: I don’t know **whether** to stay **or** leave. (Shows alternatives)
...
2. Subordinating: **Since** you’re here, let’s start the meeting.
3. Correlative: **Neither** the teacher **nor** the students were present.

---

By understanding these types and practicing with examples, you’ll gain a strong grasp of conjunctions. Let me know if you’d like more examples or further clarification! 😊
...
- **Example:**  
  ...
  - She doesn’t earn **as much as** her brother.
...
Would you like more examples in a specific context? 😊
...
✔ "Feel free to choose whichever language you are comfortable with."

✔ "Feel free to choose any language you are comfortable using."

✔ "You can choose whichever color you prefer."

✔ "They released two movies recently. You can buy a ticket for whichever movie you want."

✔ "We only have red and green shirts. You can choose whichever color you prefer."
...
- **Example:**  
  ...
  - **Now that** it’s raining, we can’t go out.
...
The food is not only fresh but also very tasty. ✅ (Correct as it is)
...
- **Examples:**  
  ...
  3. She can’t decide **whether** to study medicine **or** law.  
  4. **Whether** it rains **or** shines, the event will go on.  
  5. He asked me **whether** I wanted tea **or** coffee.


I don’t know whether I should apply for an H1B visa or not.

Which one would you like to have, tea or coffee?

I don’t know whether to join Wipro or Relex.
